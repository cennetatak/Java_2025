...
public class C02_LocalTimeMethodlari {
    ...
    public static void main(String[] args) {
        ...
        LocalTime yerelsaatHollanda = LocalTime.now(ZoneId.of("Europe/Amsterdam"));
        System.out.println("Hollanda saati : " + yerelsaatHollanda);
        ...
        System.out.println(yerelSaat.getSecond());
        System.out.println(yerelSaat.getNano());
        ...
        System.out.println(yerelSaat.plusHours(2));
        System.out.println(yerelSaat.minusHours(2).minusMinutes(15));
